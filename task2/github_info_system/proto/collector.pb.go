...
// RepoRequest contains parameters for requesting repository information
type RepoRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Owner         string                 `protobuf:"bytes,1,opt,name=owner,proto3" json:"owner,omitempty"` // Repository owner (e.g., "golang")
	Repo          string                 `protobuf:"bytes,2,opt,name=repo,proto3" json:"repo,omitempty"`   // Repository name (e.g., "go")
...
// RepoResponse contains information about a repository
type RepoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`                            // Repository name
	Description   string                 `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`              // Repository description
	Stars         int32                  `protobuf:"varint,3,opt,name=stars,proto3" json:"stars,omitempty"`                         // Number of stars
	Forks         int32                  `protobuf:"varint,4,opt,name=forks,proto3" json:"forks,omitempty"`                         // Number of forks
	CreatedAt     string                 `protobuf:"bytes,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // Creation date in RFC3339 format (e.g., "2014-08-19T04:33:40Z")
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_collector_proto_rawDesc = "" +
	"\n" +
	"\x15proto/collector.proto\x12\tcollector\"7\n" +
	...
	"\x11GetRepositoryInfo\x12\x16.collector.RepoRequest\x1a\x17.collector.RepoResponse\"\x00B\x0eZ\f./;collectorb\x06proto3"
...
var file_proto_collector_proto_depIdxs = []int32{
	0, // 0: collector.CollectorService.GetRepositoryInfo:input_type -> collector.RepoRequest
	1, // 1: collector.CollectorService.GetRepositoryInfo:output_type -> collector.RepoResponse
